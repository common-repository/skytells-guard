$(function() {
    Skytells.General();
    Skytells.Skeleton();
    Skytells.ContextMenu();
    Skytells.Tooltip();
    Skytells.Forms();
    Skytells.FileManager();
    Skytells.LoadMore();

    Skytells.RemoveListItem();
    Skytells.AsideList();
});
...
var Skytells = {};
    ...
    Skytells.DisplayFormResult = function($form, type, msg)
    {
            ...
            if (submitable) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        ...
                        Skytells.DisplayFormResult($form, "error", __("Oops! An error occured. Please try again later!"));
                    },
                    ...
                    success: function(resp) {
                        if (typeof resp.redirect === "string") {
                            ...
                            switch (result) {
                                case 1: //
                                    Skytells.DisplayFormResult($form, "success", resp.msg);
                                    if (reset) {
                                        $form[0].reset();
                                    }
                                    break;
                                ...
                                case 2: //
                                    Skytells.DisplayFormResult($form, "info", resp.msg);
                                    break;

                                default:
                                    Skytells.DisplayFormResult($form, "error", resp.msg);
                                    break;
                            }
                            $("body").removeClass("onprogress");
                        } else {
                ...
                Skytells.DisplayFormResult($form, "error", __("Fill required fields"));
            }
     ...
     */
    Skytells.RemoveListItem = function()
    {
    ...
    Skytells.FileManager = function()
    {
        ...
        // Dropbox Chooser
        Skytells.DropboxChooser();

        // OneDrive Picker
        Skytells.OnedrivePicker();
     ...
     * Dropbox Chooser
     */
    Skytells.DropboxChooser = function(settings)
    {
     ...
     * Onedrive Picker
     */
    Skytells.OnedrivePicker = function(settings)
    {
     ...
     * Confirm
     */
    Skytells.Confirm = function(data = {})
    {
        data = $.extend({}, {
     ...
     * Scheduled Posts (Day)
     */
    Skytells.ScheduledPostsDay = function()
    {
     ...
     * Expired
     */
    Skytells.CancelRecurringPayments = function()
    {
