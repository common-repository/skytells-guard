...
@include('Layouts.Header', array("title" => 'Skytells Brute Force Settings', 'page' => 'brute-force'))
<div class="content">
  <div class="container-fluid">
      ...
      <div class="metabox-holder">
          <div class="postbox sfa-brute-force">
              <?php $status = $htaccess->checkRequirements(); ?>
              <h3>
            ...
            <div class="inside">
              <form method="post" action="options.php">
                  ...
                  <div class="inside">
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input type="number" min="1" max="100" name="bflp_allowed_attempts" value="<?php echo $options['allowed_attempts']; ?>" id="bflp_allowed_attempts" class="form-control" aria-describedby="bflp_allowed_attemptsH">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input  type="number" min="1" name="bflp_reset_time" value="<?php echo $options['reset_time']; ?>"
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <input  type="number" min="1" max="10" name="bflp_login_failed_delay" value="<?php echo $options['login_failed_delay']; ?>"
                      ...
                      <div class="col-md-12">
                        <div class="checkbox">
                        <input type="checkbox" id="bflp_inform_user" name="bflp_inform_user" value="true" <?php echo ($options['inform_user']) ? 'checked' : ''; ?>>
                    ...
                    <div class="col-md-12">
                      <div class="checkbox">
                      <input type="checkbox" type="checkbox" id="bflp_send_email"  name="bflp_send_email" value="true" <?php echo ($options['send_email']) ? 'checked' : ''; ?>>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input  type="text" size="70" name="bflp_403_message" value="<?php echo $options['403_message']; ?>"
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input  type="text" size="70" name="bflp_htaccess_dir" value="<?php echo $options['htaccess_dir']; ?>"
 ...
 <div class="col-lg-6">
      ...
      <table class="wp-list-table widefat fixed">
          ...
          <tbody>
              <?php
              $i = 1;
              foreach ($htaccess->getDeniedIPs() as $deniedIP):
                  ?>
  ...
  <div class="col-lg-6">
    ...
    <table class="wp-list-table widefat fixed">
        ...
        <tbody>
            <?php
            $currentIP = $ctl->__getClientIP();

            $i = 1;
            $whitelist = $ctl->__getWhitelist();
