...
<nav class="site-navbar">
  ...
  <ul class="site-navbar-list">
     ...
     <li ng-repeat="item in ::menuItems" class="site-navbar-list-item ng-scope" ng-class="::{'with-sub-menu': item.subMenu}" ui-sref-navbar-active="selected" ba-navbar-toggling-item="item">
       <a ng-if="::!item.subMenu" class="site-navbar-list-link ng-scope" ui-state="item.stateRef || ''" ng-href="" href="admin.php?page=skytells-guard"><i class="fa fa-tachometer"></i><span class="ng-binding">Dashboard</span></a><!-- end ngIf: ::!item.subMenu --> <!-- ngIf: ::item.subMenu --><!-- ngIf: ::item.subMenu -->
     </li>
     ...
     <li ng-repeat="item in ::menuItems" class="site-navbar-list-item ng-scope with-sub-menu" ng-class="::{'with-sub-menu': item.subMenu}" ui-sref-navbar-active="selected" ba-navbar-toggling-item="item">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="admin.php?page=sfa-faceid">AI-Powered FaceID</a></li>
          ...
          <li><a href="admin.php?page=sfa-reports">Reports</a></li>


        </ul>

     </li>
     <li ng-repeat="item in ::menuItems" class="site-navbar-list-item ng-scope retina-only @if ($page == 'faceid') active @endif" ng-class="::{'with-sub-menu': item.subMenu}" ui-sref-navbar-active="selected" ba-navbar-toggling-item="item">
      <a ng-if="::!item.subMenu" class="site-navbar-list-link ng-scope" ui-state="item.stateRef || ''" ng-href="" href="admin.php?page=sfa-faceid"><i style="font-weight:400 !important;" class="fa fa-meh-o"></i><span class="ng-binding">Face ID</span></a><!-- end ngIf: ::!item.subMenu --> <!-- ngIf: ::item.subMenu --><!-- ngIf: ::item.subMenu -->
     </li>
  ...
  <? elseif ((bool)get_option('SFA_FaceID') != true): ?>
    <h5 class="not-protected"><i class="fa fa-ban text-success" style="color:#ff6565;"></i> <?php _e('YOU ARE NOT PROTECTED'); ?>
      <a href="#"  title="FaceID is currently disabled, Please Enable FaceID" data-toggle="tooltip">
        <span class="dashicons dashicons-editor-help skyav-info-toggle help-icon"></span></a>
    </h5>
